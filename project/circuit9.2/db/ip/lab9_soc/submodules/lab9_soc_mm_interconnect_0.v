...
module lab9_soc_mm_interconnect_0 (
		...
		output wire [9:0]  ocm_s1_address,                                     //                                   ocm_s1.address
	...
	wire  [105:0] vga_text_mode_controller_0_avl_mm_slave_agent_rf_source_data;                       // VGA_text_mode_controller_0_avl_mm_slave_agent:rf_source_data -> VGA_text_mode_controller_0_avl_mm_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] vga_text_mode_controller_0_avl_mm_slave_agent_rsp_fifo_out_data;                    // VGA_text_mode_controller_0_avl_mm_slave_agent_rsp_fifo:out_data -> VGA_text_mode_controller_0_avl_mm_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> VGA_text_mode_controller_0_avl_mm_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // VGA_text_mode_controller_0_avl_mm_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> VGA_text_mode_controller_0_avl_mm_slave_agent:cp_channel
	...
	wire   [28:0] ocm_s1_agent_m0_address;                                                            // ocm_s1_agent:m0_address -> ocm_s1_translator:uav_address
	...
	wire  [105:0] ocm_s1_agent_rf_source_data;                                                        // ocm_s1_agent:rf_source_data -> ocm_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] ocm_s1_agent_rsp_fifo_out_data;                                                     // ocm_s1_agent_rsp_fifo:out_data -> ocm_s1_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> ocm_s1_agent:cp_valid
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> ocm_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // ocm_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> ocm_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> ocm_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> ocm_s1_agent:cp_endofpacket
	...
	wire  [104:0] vga_text_mode_controller_0_avl_mm_slave_agent_rp_data;                              // VGA_text_mode_controller_0_avl_mm_slave_agent:rp_data -> router_003:sink_data
	...
	wire          ocm_s1_agent_rp_valid;                                                              // ocm_s1_agent:rp_valid -> router_008:sink_valid
	wire  [104:0] ocm_s1_agent_rp_data;                                                               // ocm_s1_agent:rp_data -> router_008:sink_data
	wire          ocm_s1_agent_rp_ready;                                                              // router_008:sink_ready -> ocm_s1_agent:rp_ready
	wire          ocm_s1_agent_rp_startofpacket;                                                      // ocm_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          ocm_s1_agent_rp_endofpacket;                                                        // ocm_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          ocm_s1_agent_rdata_fifo_src_valid;                                                  // ocm_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] ocm_s1_agent_rdata_fifo_src_data;                                                   // ocm_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          ocm_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_006:in_0_ready -> ocm_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> ocm_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> ocm_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // ocm_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> ocm_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ocm_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (ocm_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (ocm_s1_agent_m0_read),                          //                         .read
		.uav_write              (ocm_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (ocm_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (ocm_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (ocm_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (ocm_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (ocm_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (ocm_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (ocm_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (ocm_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (ocm_s1_write),                                  //                         .write
		.av_readdata            (ocm_s1_readdata),                               //                         .readdata
		.av_writedata           (ocm_s1_writedata),                              //                         .writedata
		.av_byteenable          (ocm_s1_byteenable),                             //                         .byteenable
		.av_chipselect          (ocm_s1_chipselect),                             //                         .chipselect
		.av_clken               (ocm_s1_clken),                                  //                         .clken
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (ocm_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (ocm_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (ocm_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (ocm_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (ocm_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (ocm_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (ocm_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (ocm_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (ocm_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (ocm_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (ocm_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (ocm_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (ocm_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (ocm_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (ocm_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (ocm_s1_agent_rp_startofpacket),                 //                .startofpacket
		...
		.rf_sink_ready           (ocm_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (ocm_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (ocm_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (ocm_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (ocm_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (ocm_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (ocm_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (ocm_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (ocm_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (ocm_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),             //                .error
		.rdata_fifo_src_ready    (ocm_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ocm_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (ocm_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (ocm_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (ocm_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (ocm_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (ocm_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (ocm_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (ocm_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (ocm_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (ocm_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (ocm_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (ocm_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	lab9_soc_mm_interconnect_0_router_004 router_008 (
		.sink_ready         (ocm_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (ocm_s1_agent_rp_valid),                         //          .valid
		.sink_data          (ocm_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (ocm_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (ocm_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ocm_s1_agent_rdata_fifo_src_data),              //     in_0.data
		.in_0_valid     (ocm_s1_agent_rdata_fifo_src_valid),             //         .valid
		.in_0_ready     (ocm_s1_agent_rdata_fifo_src_ready),             //         .ready
